...
-define(ESME_RUSSDINVLOGIC, 16#000004B1).
-define(EMSE_RUSSDUNSUPPOPER, 16#000004B2).
-define(ESME_RUSSDGSMSYSFAIL, 16#000004B3).
-define(ESME_RUSSDGSMDATAMISS, 16#000004B4).
-define(ESME_RUSSDGSMUNEXPDATAVAL, 16#000004B5).
-define(ESME_RUSSDGSMUNKNWALPH, 16#000004B6).
-define(ESME_RUSSDGSMABSSUB, 16#000004B7).
-define(ESME_RUSSDGSMILLSUB, 16#000004B8).
-define(ESME_RUSSDGSMILLEQUP, 16#000004B9).
-define(ESME_RUSSDGSMBUSY, 16#000004BA).
-define(ESME_RUSSDGSMCALLBAR, 16#000004BB).
-define(ESME_RUSSDGSMNETFAIL, 16#000004BC).
-define(ESME_RUSSDGSMTIMEXP, 16#000004BD).
-define(ESME_RUSSDGSMFACNSUP, 16#000004BE).
-define(ESME_RUSSDGSMUNKNSUB, 16#000004BF).
-define(ESME_RUSSDGSMTELSRVNPRV, 16#000004C0).
-define(ESME_RUSSDSESSIONTERMABN, 16#000004C1).
